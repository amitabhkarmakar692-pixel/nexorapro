...
export default function BuyerSignupPage() {
  ...
  async function handleSignup() {
    if (!supabase) {
      setError("Supabase keys are missing. Please add NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY in your settings.");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-ngray-light w-full max-w-md p-8">
        ...
        {!isConfigured && (
          <div className="bg-amber-50 border border-amber-200 text-amber-800 text-xs px-4 py-3 rounded-xl mb-5">
